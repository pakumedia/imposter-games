...
export function InlineGameSettings({
  ...
  return (
    <div className="space-y-4">
      {/* Impostor Count */}
      <GameCard color="subtle" className="p-4 bg-destructive/5">
      ...
      {/* Categories */}
      <GameCard color="subtle" className="p-4 bg-game-purple/5">
      ...
      {/* Impostor Helpers */}
      <GameCard color="subtle" className="p-4 bg-game-yellow/5">
      ...
      {/* Time Settings */}
      <GameCard color="subtle" className="p-4 bg-game-teal/5">
        <h3 className="font-bold text-body-sm text-foreground mb-3 flex items-center gap-2">
